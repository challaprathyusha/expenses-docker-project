...
- We should check for application compatibility with the containers, if application size is more than 500MB, we should make it compatible to be run in containers. 
- Large size applications are not suitable for containerization, it leads to the performance issue of an application.
## 2. Keep Images Small
